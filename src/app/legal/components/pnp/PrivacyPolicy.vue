  ...
  <div>
    <div :class="sectionClass.wrapper">
      ...
      <p>
        ...
        >
          <span>Privacy Policy Generator</span> </a
        >.
      </p>
    </div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &quot;Our&quot; in this Agreement) refers to Let's Play.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Let's Play, accessible from
            <a :href="domain" rel="external nofollow noopener" target="_blank" class="text-decoration-none">
              {{ domain }}
            </a>
          </p>
        </li>
