<template>
  <div>
    <div id="our-pledge" :class="sectionClass.wrapper">
      <h2>Our Pledge</h2>
    ...
    <div id="our-standards" :class="sectionClass.wrapper">
      <h2>Our Standards</h2>
    ...
    <div id="enforcement-responsibilities" :class="sectionClass.wrapper">
    ...
    <div id="scope" :class="sectionClass.wrapper">
      <h2>Scope</h2>
    ...
    <div id="enforcement" :class="sectionClass.wrapper">
      <h2>Enforcement</h2>
      ...
      <p>
        ...
        <a :href="`mailto:${authorMeta.email}`" class="pl-1 text-decoration-none">{{ authorMeta.email }}</a>
        <span>. All complaints will be reviewed and investigated promptly and fairly.</span>
      </p>

      <p>All community leaders are obligated to respect the privacy and security of the reporter of any incident.</p>
    </div>

    <div id="enforcement-guidelines" :class="sectionClass.wrapper">
      ...
      <div>
        ...
        <div class="pl-4">
          ...
          <p>
            <strong>Consequence</strong>: A private, written warning from community leaders, providing clarity around
            the nature of the violation and an explanation of why the behavior was inappropriate. A public apology may
            be requested.
          </p>
        </div>
      </div>
      ...
      <div>
        <h3 class="mb-2">2. Warning</h3>

        <div class="pl-4">
          <p><strong>Community Impact</strong>: A violation through a single incident or series of actions.</p>

          <p>
            <strong>Consequence</strong>: A warning with consequences for continued behavior. No interaction with the
            people involved, including unsolicited interaction with those enforcing the Code of Conduct, for a specified
      ...
      <div>
        <h3 class="mb-2">3. Temporary Ban</h3>
        ...
        <div class="pl-4">
          ...
          <p>
            <strong>Consequence</strong>: A temporary ban from any sort of interaction or public communication with the
      ...
      <div>
        <h3 class="mb-2">4. Permanent Ban</h3>

        <div class="pl-4">
          <p>
            <strong>Community Impact</strong>: Demonstrating a pattern of violation of community standards, including
            sustained inappropriate behavior, harassment of an individual, or aggression toward or disparagement of
    ...
    <div id="attribution" :class="sectionClass.wrapper">
      <h2>Attribution</h2>

      <p>
        <span>This Code of Conduct is adapted from the</span>
        <a v-bind="linkProps" :href="links.covenantHome" class="px-1">Contributor Covenant</a>
        <span>version 2.1, available at</span>
        <a v-bind="linkProps" :href="links.v2_1Coc" class="px-1">{{ links.v2_1Coc }}</a>
      </p>

      <p>
        <span>Community Impact Guidelines were inspired by</span>
        <a v-bind="linkProps" :href="links.mozilaCoc" class="px-1">Mozilla's code of conduct enforcement ladder</a>
      </p>

      <p>
        <span>For answers to common questions about this code of conduct, see the FAQ at</span>
        <a v-bind="linkProps" :href="links.covenantFaq" class="px-1">{{ links.covenantFaq }}</a>
        <span>Translations are available at</span>
        <a v-bind="linkProps" :href="links.covenantTranslation" class="px-1">{{ links.covenantTranslation }}</a>
      </p>
    </div>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      sectionClass: { wrapper: 'mb-8' },
      linkProps: { target: '_blank', rel: 'nofollow noopener noreferrer', class: 'text-decoration-none' },
      links: {
        covenantHome: 'https://www.contributor-covenant.org',
        v2_1Coc: 'https://www.contributor-covenant.org/version/2/1/code_of_conduct.html',
        mozilaCoc: 'https://github.com/mozilla/diversity',
        covenantFaq: 'https://www.contributor-covenant.org/faq',
        covenantTranslation: 'https://www.contributor-covenant.org/translations',
      },
